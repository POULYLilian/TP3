  ...
  <div class="detail">
    <div class="detail-view card" >
      <div class="data card-body" >
        ...
        <div class="types">
          <div class="type" 
            v-for="(value, index) in donnees.types"
        ...
        <h3>Abilities</h3>
        <div class="abilities">
          <div class="ability" v-for="(index) in donnees.abilities"
          :key="index" >
          {{index.ability.name}}</div>
        </div>
        <h3>Specs</h3>
        <div class="property">
          <div class="left">Height</div>
          <div class="right">{{donnees.height/10}} meter</div>
        </div>
        <div class="property">
          <div class="left">Weight</div>
          <div class="right">{{donnees.weight/10}} kg</div>
        </div>
        

        <div class="image">
          <img :src="imageUrl+ '/'+donnees.name+'.png'" >
        
      </div>
      </div>
      <button class="close" v-on:click="close_detail">Fermer</button>
    </div>
  </div>
</template>
...
export default {
  ...
  data:() => {
    ...
    methods:{
      ...
      .then(data => (this.donnees = data.data))
    },
};
</script>
